...
if (!root) {
  ...
  if (!controls) {
    ...
    const formCodec = createFormCodec({
      ...
      inputSiteSocialGithubDisplayText: controls.inputSiteSocialGithubDisplayText,
      inputSiteSocialXOrder: controls.inputSiteSocialXOrder,
      inputSiteSocialX: controls.inputSiteSocialX,
      inputSiteSocialXDisplayText: controls.inputSiteSocialXDisplayText,
      inputSiteSocialEmailOrder: controls.inputSiteSocialEmailOrder,
      inputSiteSocialEmail: controls.inputSiteSocialEmail,
      inputSiteSocialEmailDisplayText: controls.inputSiteSocialEmailDisplayText,
      ...
      inputPageLongformTitle: controls.inputPageLongformTitle,
      inputPageLongformSubtitle: controls.inputPageLongformSubtitle,
      inputPageArchiveTitle: controls.inputPageArchiveTitle,
      inputPageArchiveSubtitle: controls.inputPageArchiveSubtitle,
      inputPageMaterialsTitle: controls.inputPageMaterialsTitle,
      inputPageMaterialsSubtitle: controls.inputPageMaterialsSubtitle,
      inputPageBitsTitle: controls.inputPageBitsTitle,
      inputPageBitsSubtitle: controls.inputPageBitsSubtitle,
      inputPageReadsTitle: controls.inputPageReadsTitle,
      inputPageReadsSubtitle: controls.inputPageReadsSubtitle,
