...
export type ContentEditorSaveInput = ContentEditorSaveBaseInput & (
  ...
  | {
      collection: 'picks';
      frontmatter: AdminPicksEditorValues;
      body?: string;
    }
  | {
      collection: 'materials';
      frontmatter: AdminMaterialsEditorValues;
    }
  | {
      collection: 'memo';
      body: string;
...
export type ContentEditorCreateInput = {
  ...
  | {
      collection: 'picks';
      frontmatter: Partial<AdminPicksEditorValues> & {
        reason?: string;
        body?: string;
      };
    }
  | {
      collection: 'materials';
      frontmatter: Partial<AdminMaterialsEditorValues>;
    }
);
