...
const forbiddenAssertions = [
  [
    editorToolbarSource,
    /import\(\s*['"]emoji-picker-element['"]\s*\)|new Picker\(|emoji-picker-element-data/u,
